  ...
  if (api) {
    ...
    function cell(item) {
      if (item.url && item.title) {
        ...
        cell += '<img src="' + (item.screenshot || ('https://s0.wp.com/mshots/v1/' + item.url + '?w=1280&h=720')) + '" onerror="javascript:this.removeAttribute(&quot;data-src&quot;);this.src=&quot;' + hexo.theme.config.default.cover + '&quot;;"/>';
        cell += '<div class="info">';
